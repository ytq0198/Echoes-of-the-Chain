...
当前阶段：Iteration 5 完整角色界面与二维码验真。真实 Fabric 2.5 LTS 网络、三类属性身份、短期签名会话、Fastify Gateway 与四角色 Web 工作台已经贯通；全部角色页面已统一到以链上证据、授权边界和学术凭证为核心的视觉系统，学生私有成绩仍须通过 HTTP 会话和链码证书 `subject.hash` 双重校验才能读取。
