...
当前阶段：Iteration 8 限时最小披露。真实 Fabric 2.5 LTS 网络、三类属性身份、短期签名会话、Fastify Gateway 与四角色 Web 工作台已经贯通；学生可为有效凭证创建绑定字段、用途、验证者、期限和次数的 bearer capability，公开验证者消费授权后只获得被选择的成绩字段。
