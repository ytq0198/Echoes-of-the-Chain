...
<template>
  <main>
    ...
    <template v-if="currentView === 'home'">
      ...
      <section class="evidence-section"><div class="shell evidence-grid"><div><p class="eyebrow light">VERIFIED ON REAL FABRIC</p><h2>不是原型截图，<br />是真实交易闭环。</h2></div><dl class="metrics"><div><dt>24</dt><dd>自动测试</dd></div><div><dt>91.32%</dt><dd>链码语句覆盖率</dd></div><div><dt>2</dt><dd>独立组织批准</dd></div><div><dt>13</dt><dd>E2E 后账本高度</dd></div></dl></div></section>
    </template>
